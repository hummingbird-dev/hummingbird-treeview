...
&nbsp;&nbsp;&nbsp; If you want to add a node including children, *end_node* must be set to *false* and an object containing the children must be 
   passed to the method with name *children*:
